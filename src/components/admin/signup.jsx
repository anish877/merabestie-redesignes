...
const AdminSignup = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/admin/seller/signup', {
        method: 'POST',
        headers: {
  ...
  const handleVerificationMethodSelect = async (method) => {
    ...
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/admin/seller/send-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/seller/send-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/seller/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
