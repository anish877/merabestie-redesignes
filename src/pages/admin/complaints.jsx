...
const Complaints = () => {
  ...
  const fetchComplaints = async () => {
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/complaints/get-complaints');
      const data = await response.json();
  ...
  const handleStatusChange = async (complaintId, newStatus) => {
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/update-complaint-status', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
