...
const Order = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        const response = await fetch(`https://merabestie-backend.onrender.com/find-my-order`, {
          method: 'POST',
          headers: {
  ...
  const fetchProductDetails = async (productId) => {
    try {
      const response = await fetch('https://merabestie-backend.onrender.com/:productId', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
